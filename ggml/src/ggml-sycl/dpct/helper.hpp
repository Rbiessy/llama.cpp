...
// fallback to runtime dispatching.
    ...
    bool is_cpu = stream->get_device().get_info<sycl::info::device::device_type>() == sycl::info::device_type::cpu;
    return is_cpu ? oneapi::math::backend_selector<oneapi::math::backend::mklcpu>{ queue } : oneapi::math::backend_selector<oneapi::math::backend::mklgpu>{ *stream };
